"""
Django settings for CSDepartmentLib project.
...
ALLOWED_HOSTS = ['sjeccselibrary.herokuapp.com']
...
ROOT_URLCONF = 'CSDepartmentLib.urls'
...
WSGI_APPLICATION = 'CSDepartmentLib.wsgi.application'
